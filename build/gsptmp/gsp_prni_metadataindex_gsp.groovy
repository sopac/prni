...
class gsp_prni_metadataindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/metadata/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(8)
expressionOut.print(prni.Metadata.list().size())
printHtmlPart(9)
...
printHtmlPart(12)
invokeTag('table','f',22,['collection':(metadataList)],-1)
printHtmlPart(13)
invokeTag('paginate','g',25,['total':(metadataCount ?: 0)],-1)
printHtmlPart(14)
})
...
public static final long LAST_MODIFIED = 1468801583000L
