...
class gsp_prni_layoutsmain_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(5)
invokeTag('image','asset',28,['src':("stars.png"),'style':("margin-top: -7px;")],-1)
printHtmlPart(6)
invokeTag('pageProperty','g',34,['name':("page.nav")],-1)
printHtmlPart(7)
invokeTag('layoutBody','g',40,[:],-1)
printHtmlPart(8)
invokeTag('message','g',49,['code':("spinner.alt"),'default':("Loading&hellip;")],-1)
printHtmlPart(9)
invokeTag('javascript','asset',52,['src':("application.js")],-1)
printHtmlPart(10)
})
...
public static final long LAST_MODIFIED = 1468390137000L
